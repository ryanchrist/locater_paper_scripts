...
# path to locater16 results folder (containing .rds files containing simulation output based on the locater12.R script)
results_path <- "~/Dropbox/Hall_group/locater_sims/locater16/"
...
data.table::fwrite(res,paste0(collected_results_path,"locater16.csv.gz"))
