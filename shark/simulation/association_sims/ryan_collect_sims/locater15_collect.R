...
# path to locater15 results folder (containing .rds files containing simulation output based on the locater12.R script)
results_path <- "~/Dropbox/Hall_group/locater_sims/locater15/"
...
data.table::fwrite(res,paste0(collected_results_path,"locater15.csv.gz"))
