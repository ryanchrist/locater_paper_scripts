...
# This is an exact copy of locater15 except that we're only looking at the 9 causal variant
# case with a causal variant window of 100 kb (all causal variants hidden as in locater15)
