...
# This is an exact copy of locater14 except that we're only looking at the 9 causal variant
# case with a causal variant window of 100 kb (all causal variants observed as in locater14)
# see def of x_key around line 118
