...
# locater15 is identical to locater14 except that
# here the proportion of causal variants that is hidden is 1 (all are hidden)
# where as in locater14 all causal variants were observed
# see line 128
